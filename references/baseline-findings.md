...
- A time-pressured mixed-media baseline used only a small remembered/reference subset, silently omitted other relevant sites, and produced no access-date, query, sample, curation-mechanism, limitation, or fallback-authorization audit. Live-reference readiness now gates inventory and culling.
